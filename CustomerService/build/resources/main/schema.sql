...
--CREATE TABLE "CUSTOMERS" ("ID" INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), "USERNAME" VARCHAR(255), "PASSWORD" VARCHAR(255));
CREATE TABLE "CUSTOMERS" ("ID" INT, "NAME" VARCHAR(255), "PASSWORD" VARCHAR(255), "EMAIL" VARCHAR(255));
-- ----------------------------------------------
